...
public abstract class BaseCoreJsonNodeVisitor<T> {
    ...
    protected CoreJsonNode<T> visitGenericNode(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
    ...
    protected CoreJsonNode<T> visitArrayChildren(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        ...
        for (int i = 0; i < node.getArrayElements().size(); i++) {
            ...
            CoreJsonNode<T> newChild = visitGenericNode(context.descend(i, node, new CoreJsonPathElement(Integer.toString(i), array), null), child);
    ...
    protected CoreJsonNode<T> visitBinary(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitBoolean(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitNull(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitNumber(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitString(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitObject(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        return visitAtomNode(context, node);
    }

    protected CoreJsonNode<T> visitObjectChildren(CoreJsonNodeVisitorContext<T> context, CoreJsonNode<T> node) {
        ...
        for (int i = 0; i < node.getObjectElements().size(); i++) {
            ...
            CoreJsonNodeVisitorContext<T> newContext = context.descend(key, node, objectPathElement, objectPathElement);
