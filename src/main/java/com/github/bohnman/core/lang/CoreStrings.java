...
public class CoreStrings {
    ...
    public static String camelCapitalized(String str) {
        return camel(str, true);
    ...
    private static String camel(String str, boolean capitalizeFirst) {
        ...
        char firstChar = capitalizeFirst ? Character.toUpperCase(chars[0]) : chars[0];
        ...
        char lastCh = chars[chars.length - 1];
        builder.append(upper ? Character.toUpperCase(lastCh) : lastCh);
