...
/**
 * A specification of a {@link CoreCacheBuilder} configuration.
 * <p>
 ...
 * <ul>
 * <li>{@code maximumSize=[long]}: sets {@link CoreCacheBuilder#setMaximumWeight(long)}.
 * <li>{@code maximumWeight=[long]}: sets {@link CoreCacheBuilder#maximumWeight}.
 * <li>{@code expireAfterAccess=[duration]}: sets {@link CoreCacheBuilder#setExpireAfterAccess(long, TimeUnit)}.
 * <li>{@code expireAfterWrite=[duration]}: sets {@link CoreCacheBuilder#setExpireAfterWrite(long, TimeUnit)}.
 * </ul>
 * <p>
 ...
 * {@link CoreCacheBuilder#from(CoreCacheBuilderSpec)} or {@link CoreCacheBuilder#from(String)}.
 *
 * @author Adam Winer
 * @since 12.0
 */
public final class CoreCacheBuilderSpec {
    /**
     * Parses a single value.
     */
    private interface ValueParser {
        void parse(CoreCacheBuilderSpec spec, String key, @Nullable String value);
    }
    ...
    private CoreCacheBuilderSpec(String specification) {
     ...
     */
    public static CoreCacheBuilderSpec parse(String cacheBuilderSpecification) {

        CoreCacheBuilderSpec spec = new CoreCacheBuilderSpec(cacheBuilderSpecification);
     ...
     */
    public static CoreCacheBuilderSpec disableCaching() {
        // Maximum size of zero is one way to block caching
        return CoreCacheBuilderSpec.parse("maximumSize=0");
    }

    /**
     * Returns a CacheBuilder configured according to this instance's specification.
     */
    CoreCacheBuilder<Object, Object> toCacheBuilder() {
        CoreCacheBuilder<Object, Object> builder = CoreCacheBuilder.builder();
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof CoreCacheBuilderSpec)) {
            return false;
        }
        CoreCacheBuilderSpec that = (CoreCacheBuilderSpec) obj;
    ...
    abstract static class IntegerParser implements ValueParser {
        protected abstract void parseInteger(CoreCacheBuilderSpec spec, int value);

        @Override
        public void parse(CoreCacheBuilderSpec spec, String key, String value) {
    ...
    abstract static class LongParser implements ValueParser {
        protected abstract void parseLong(CoreCacheBuilderSpec spec, long value);
    ...
    static class MaximumSizeParser extends LongParser {
        @Override
        protected void parseLong(CoreCacheBuilderSpec spec, long value) {
    ...
    abstract static class DurationParser implements ValueParser {
        protected abstract void parseDuration(CoreCacheBuilderSpec spec, long duration, TimeUnit unit);
    ...
    static class AccessDurationParser extends DurationParser {
        @Override
        protected void parseDuration(CoreCacheBuilderSpec spec, long duration, TimeUnit unit) {
